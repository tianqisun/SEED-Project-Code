...
% input: SWC file
% arr 1: partition asymmetry at branch points based on terminal nodes;
% arr2: length based partition symmetry
% output: average ratio of all branches; two values, terminal then length
array = zeros(1,2);
